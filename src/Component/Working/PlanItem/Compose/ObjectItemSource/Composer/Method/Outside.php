...
use Eki\NRW\Component\Working\PlanItem\Compose\ObjectItemSource\Composer\Method;
use Eki\NRW\Component\Working\PlanItem\Compose\ObjectItemSource\Composer\MethodInterface;

/**
* @author Nguyen Tien Hy <ngtienhy@gmail.com>
*/
abstract class Outside extends Method
{
	/**
	* @inheritdoc
	*/
	...
	{
		return MethodInterface::METHOD_OUTSIDE;	
	}
}
