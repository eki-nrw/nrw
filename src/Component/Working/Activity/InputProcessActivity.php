...
*/
class InputProcessActivity extends ProcessActivity
{
	/**
	* @inheritdoc
	*/
	protected function matchActivityType(ActivityTypeInterface $activityType)
	{
		...
		if (!$activityType->is('input'))
			throw new \InvalidArgumentException("Input Process Activity must be input type.");
	}
}
