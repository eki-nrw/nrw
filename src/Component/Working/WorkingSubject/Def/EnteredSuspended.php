...
*/
abstract class EnteredSuspended extends AbstractAim
{
	/**
	* @inheritdoc
	* 
	*/	
	...
	protected function onAim($name, $subject, array $contexts)
	{
		...
		// When the subject	has been suspended, his/her advanced subject should be suspended also
		$this->getTool()
			->getWorkingSubject(Definitions::WORKING_TYPE, $advancedSubject)
			->action(Definitions::WA_SUSPEND, $contexts)
		;
	}
}
